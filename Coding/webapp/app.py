...
from routes import (
    ...
    scatter, team_viz, rankings, scraping, matches,
)
from routes import manual_import
from routes import manual_match_import
from routes import transfermarkt

_BLUEPRINTS = [
    core.bp, compatibility.bp, exports.bp,
    scatter.bp, team_viz.bp, rankings.bp, scraping.bp, matches.bp,
    manual_import.bp,
    manual_match_import.bp,
    transfermarkt.bp,
]
...
if __name__ == '__main__':
    ...
    if os.environ.get('WERKZEUG_RUN_MAIN') != 'true':
        print('\n  Scout is running — open in your browser:')
